    ...
    <>
      ...
      <div className="flex w-full h-screen">
        <Article
          ...
          description="Une verticalité qui dialogue avec la densité urbaine tout en préservant une légèreté visuelle grâce à sa facade pixélisée."
        />
        <div className="w-1/2">
      ...
      <div className="flex w-full h-screen">
        <Article
          title="Musée de la lumière | Toyko, 2021"
          description="Quand l'architecture deveint médium entre la lumière naturelle et l'expérience contemplative."
        />
        <div className="w-1/2">
